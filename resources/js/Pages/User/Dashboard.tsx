                                    ...
                                    {currentStage.name ===
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <a
                                                ...
                                                download
                                                className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-blue-700 bg-blue-100 border border-blue-300 rounded-lg hover:bg-blue-200 hover:text-blue-800 transition-colors mt-3"
                                            >
                                                <svg
