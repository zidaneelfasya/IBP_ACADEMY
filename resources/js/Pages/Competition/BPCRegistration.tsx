...
export default function BPCRegistration({
                ...
                return (
                    <div>
                        ...
                        <div className="p-4 mt-4 border rounded-lg border-ibp-neutral bg-ibp-neutral/30">
                            <h3 className="mb-2 font-semibold text-ibp-primary">
    ...
    return (
        <>
            ...
            <div className="min-h-screen py-4 border-2 border-white sm:py-8 bg-gradient-to-br from-neutral-200 to-white">
                    ...
                    <div className="flex items-start max-w-6xl gap-4 mx-auto">
                        ...
                        <div className="flex-1 max-w-4xl">
                            <div className="overflow-hidden bg-white rounded-lg shadow-xl">
                                ...
                                {existingRegistration && (
                                    <div className="px-4 py-4 m-6 bg-green-50 border border-green-200 rounded-lg">
                                        ...
                                        <div className="flex flex-col justify-between gap-4 pt-6 mt-8 border-t sm:flex-row border-ibp-neutral">
                                            <button
                                                ...
                                                className={`order-2 sm:order-1 px-4 sm:px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
                                                    currentStep === 1
                                                        ...
                                                        : "bg-ibp-secondary text-ibp-white hover:bg-ibp-neutral/80 hover:shadow-md"
                                                }`}
                                            >
                                                ← Sebelumnya
                                            </button>
                                            ...
                                            {currentStep < totalSteps ? (
                                                <button
                                                    type="button"
                                                    onClick={nextStep}
                                                    className="order-1 px-4 py-3 font-medium transition-all duration-200 rounded-lg sm:order-2 sm:px-6 text-ibp-white bg-gradient-to-r from-blue-900 to-blue-600 hover:from-blue-900/90 hover:to-blue-600/90 hover:shadow-lg shadow-ibp-primary/25"
                                                >
                                                    Selanjutnya →
                                                </button>
                                            ) : (
                                                <button
                                                    ...
                                                    className={`order-1 sm:order-2 px-4 sm:px-6 py-3 rounded-lg font-medium text-ibp-white transition-all duration-200 ${
                                                        ...
                                                        existingRegistration
                                                            ...
                                                            : "bg-gradient-to-r from-green-300 to-green-500 hover:from-green-300/90 hover:to-green-500/90 hover:shadow-lg shadow-green-300/25"
                                                    }`}
                                                >
                                                    {processing
                                                        ? "Mendaftar..."
